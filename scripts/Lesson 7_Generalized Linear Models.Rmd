...
```{r, include=FALSE}
#Necessary Libraries
pacman::p_load(agridat, tidyverse, here, car, # data import and handling
               conflicted, # handling function conflicts
               emmeans, multcomp, multcompView, # adjusted mean comparisons
               ggpp, desplot, gridExtra, ggfortify, viridis, # plots
               performance, DHARMa) #Others
...
```{r}
simulateResiduals(mod1, n = 1000, plot = T)
simulateResiduals(mod2, n = 1000, plot = T)
...
```{r}
data <- read_csv(here("data","Logistic_Regression.csv"))
